...
const columns = [
  { id: "categoryImage", label: "Ảnh danh mục", minWidth: 150 },
  { id: "categoryName", label: "Tên danh mục", minWidth: 250 },
    ...
    <>
      ...
      <div className="card my-4 shadow-md sm:rounded-lg bg-white">
        <div className="flex items-center justify-between px-5 py-5">
          <h2 className="text-[18px] font-[600]">Danh sách danh mục (MUI)</h2>
        </div>
